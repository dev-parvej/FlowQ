...
<form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
    ...
    <div class="question-card">
        <h3 class="card-title"><?php echo esc_html__('Question Details', FLOWQ_TEXT_DOMAIN); ?></h3>
        <div class="card-content">
            <div class="form-field">
                <label for="question_title" class="field-label">
                    <?php echo esc_html__('Question Title', FLOWQ_TEXT_DOMAIN); ?> *
                </label>
                <input type="text"
                       id="question_title"
                       name="question_title"
                       ...
                       placeholder="<?php echo esc_attr__('What is your favorite color?', FLOWQ_TEXT_DOMAIN); ?>" />
            </div>
            ...
            <div class="form-field">
                ...
                <textarea id="question_description"
                          ...
                          rows="3"
                          placeholder="<?php echo esc_attr__('Please choose the option that best describes your preference...', FLOWQ_TEXT_DOMAIN); ?>"><?php echo esc_textarea($question_data['description'] ?? ''); ?></textarea>
            </div>

            <div class="form-field">
                <label for="question_extra_message" class="field-label">
                    <?php echo esc_html__('Extra Message', FLOWQ_TEXT_DOMAIN); ?>
                    <span class="help-tooltip" data-tooltip="<?php echo esc_attr__('Message shown after the participant answers. Use this to provide feedback or next steps.', FLOWQ_TEXT_DOMAIN); ?>">
                ...
                <textarea id="question_extra_message"
                          ...
                          class="full-width-textarea"
                          rows="3"
                          placeholder="<?php echo esc_attr__('Thank you for your answer! Our team will contact you if needed.', FLOWQ_TEXT_DOMAIN); ?>"><?php echo esc_textarea($question_data['extra_message'] ?? ''); ?></textarea>
            </div>
            ...
            <div>
                <label class="checkbox-field">
                    ...
                    <span class="checkbox-label">
                        <?php echo esc_html__('This question is required', FLOWQ_TEXT_DOMAIN); ?>
                        <span class="help-tooltip" data-tooltip="<?php echo esc_attr__('When unchecked, participants can skip this question using a skip button.', FLOWQ_TEXT_DOMAIN); ?>">
                            <span class="dashicons dashicons-editor-help"></span>
                        </span>
                    </span>
                </label>
            ...
            <div class="form-field skip-destination-field" style="display: none; margin-top: 20px;">
                <label for="question_skip_next_question_id" class="field-label">
                    <?php echo esc_html__('Skip Destination', FLOWQ_TEXT_DOMAIN); ?>
                    <span class="help-tooltip" data-tooltip="<?php echo esc_attr__('Choose which question to show when participants skip this question.', FLOWQ_TEXT_DOMAIN); ?>">
                        <span class="dashicons dashicons-editor-help"></span>
                    </span>
                </label>
    ...
    <div class="question-card">
        <div class="card-header">
            <h3 class="card-title"><?php echo esc_html__('Answer Options', FLOWQ_TEXT_DOMAIN); ?></h3>
            <button type="button" class="button button-secondary-outlined" id="add-answer-option">
                <span class="dashicons dashicons-plus-alt2"></span>
                <?php echo esc_html__('Add Answer Option', FLOWQ_TEXT_DOMAIN); ?>
            </button>
        </div>
        <div class="card-content">
                        ...
                        <div class="answer-option-card">
                            <div class="answer-card-header" data-toggle="collapse">
                                <div class="answer-header-left">
                                    <span class="answer-preview"><?php echo esc_html($answer['answer_text'] ?: __('New Answer Option', FLOWQ_TEXT_DOMAIN)); ?></span>
                                </div>
                                <div class="answer-header-right">
                                    <button type="button" class="button-icon collapse-toggle" title="<?php echo esc_attr__('Expand/Collapse', FLOWQ_TEXT_DOMAIN); ?>">
                                        <span class="dashicons dashicons-arrow-down-alt2"></span>
                                    </button>
                                    <button type="button" class="button-icon remove-answer-option" title="<?php echo esc_attr__('Remove', FLOWQ_TEXT_DOMAIN); ?>">
                            ...
                            <div class="answer-card-content collapsible-content">
                                <div class="form-field">
                                    <label class="field-label"><?php echo esc_html__('Answer Text', FLOWQ_TEXT_DOMAIN); ?></label>
                                    <input type="text"
                                           name="answer_text[]"
                                           class="full-width-input"
                                           value="<?php echo esc_attr($answer['answer_text']); ?>"
                                           placeholder="<?php echo esc_attr__('Blue', FLOWQ_TEXT_DOMAIN); ?>"
                                           required>
                                ...
                                <div class="form-field">
                                    <label class="field-label">
                                        <?php echo esc_html__('Next Question', FLOWQ_TEXT_DOMAIN); ?>
                                        <span class="help-tooltip" data-tooltip="<?php echo esc_attr__('Choose which question to show next when this answer is selected.', FLOWQ_TEXT_DOMAIN); ?>">
                                            <span class="dashicons dashicons-editor-help"></span>
                                        </span>
                                    </label>
                                    <select name="next_question_id[]" class="full-width-select">
                                        <option value=""><?php echo esc_html__('— End survey or continue to next question —', FLOWQ_TEXT_DOMAIN); ?></option>
                                        <?php foreach ($questions as $q): ?>
                                            <?php if ($q['id'] != ($question_data['id'] ?? 0)): ?>
                                ...
                                <div class="advanced-options-section">
                                    <button type="button" class="advanced-options-toggle" data-collapsed="true">
                                        ...
                                        <?php echo esc_html__('Advanced Options', FLOWQ_TEXT_DOMAIN); ?>
                                    </button>
                                    <div class="advanced-options-content" style="display: none;">
                                        <div class="form-field">
                                            <label class="field-label">
                                                <?php echo esc_html__('Redirect URL', FLOWQ_TEXT_DOMAIN); ?>
                                                <span class="help-tooltip" data-tooltip="<?php echo esc_attr__('Optional: Redirect to an external URL when this answer is selected (instead of continuing the survey).', FLOWQ_TEXT_DOMAIN); ?>">
                                                    <span class="dashicons dashicons-editor-help"></span>
                                                </span>
                                            </label>
                                            <input type="url"
                                                   ...
                                                   placeholder="<?php echo esc_attr__('https://example.com/thank-you', FLOWQ_TEXT_DOMAIN); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="action-buttons">
        <div class="primary-actions">
            <input type="submit" class="button button-primary-custom" value="<?php echo esc_attr($is_editing ? __('Update Question', FLOWQ_TEXT_DOMAIN) : __('Create Question', FLOWQ_TEXT_DOMAIN)); ?>">
        </div>
...
<div id="answer-option-template" style="display: none;">
    <div class="answer-option-card">
        <div class="answer-card-header" data-toggle="collapse">
            <div class="answer-header-left">
                <span class="answer-preview"><?php echo esc_html__('New Answer Option', FLOWQ_TEXT_DOMAIN); ?></span>
            </div>
            <div class="answer-header-right">
                <button type="button" class="button-icon collapse-toggle" title="<?php echo esc_attr__('Expand/Collapse', FLOWQ_TEXT_DOMAIN); ?>">
                    <span class="dashicons dashicons-arrow-down-alt2"></span>
...
jQuery(document).ready(function($) {
    ...
    $(document).on('input', 'input[name="answer_text[]"]', function() {
        ...
        if (text) {
            ...
            $preview.text('<?php echo esc_js(__('New Answer Option', FLOWQ_TEXT_DOMAIN)); ?>');
        }
    });
