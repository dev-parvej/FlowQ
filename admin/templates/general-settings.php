...
<div class="general-settings-wrapper">
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
        ...
        <div class="settings-section">
            <h2><?php echo esc_html__('Form Settings', FLOWQ_TEXT_DOMAIN); ?></h2>
            <table class="form-table">
                <!-- Setting 1: Two-Stage Form -->
                <tr>
                    <th scope="row">
                        <label for="two_stage_form">
                            <?php echo esc_html__('Two-Stage Form', FLOWQ_TEXT_DOMAIN); ?>
                        </label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php echo esc_html__('Enable two-stage participant form', FLOWQ_TEXT_DOMAIN); ?>
                        </label>
                        <p class="description">
                            <?php echo esc_html__('When enabled, participants will provide basic information first (name, email, address, zipcode), then phone number in a second step. When disabled, all fields appear together.', FLOWQ_TEXT_DOMAIN); ?>
                        </p>
                    </td>
                </tr>
                ...
                <!-- <tr>
                    <th scope="row">
                        <label for="two_page_mode">
                            <?php echo esc_html__('Two-Page Survey', FLOWQ_TEXT_DOMAIN); ?>
                        </label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php echo esc_html__('Enable two-page survey form', FLOWQ_TEXT_DOMAIN); ?>
                        </label>
                        <p class="description">
                            <?php echo esc_html__('When enabled, participant information and survey questions will be displayed on separate pages. You\'ll need to add the survey shortcode to both pages and configure the second page URL in each survey\'s settings.', FLOWQ_TEXT_DOMAIN); ?>
                        </p>
                    </td>
                </tr> -->
                ...
                <tr>
                    <th scope="row">
                        <label for="allow_duplicate_emails">
                            <?php echo esc_html__('Multiple Submissions', FLOWQ_TEXT_DOMAIN); ?>
                        </label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php echo esc_html__('Allow multiple submissions with same email', FLOWQ_TEXT_DOMAIN); ?>
                        </label>
                        <p class="description">
                            <?php echo esc_html__('When enabled, users can submit the same survey multiple times using the same email address. When disabled, each email can only submit once per survey.', FLOWQ_TEXT_DOMAIN); ?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <div class="settings-section">
            <h2><?php echo esc_html__('Participant Information Fields', FLOWQ_TEXT_DOMAIN); ?></h2>
            <table class="form-table">
                <tr>
                    <th scope="row">
                        <?php echo esc_html__('Required Fields', FLOWQ_TEXT_DOMAIN); ?>
                    </th>
                    <td>
                        <p><strong><?php echo esc_html__('Name and Email are always required', FLOWQ_TEXT_DOMAIN); ?></strong></p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <?php echo esc_html__('Optional Fields', FLOWQ_TEXT_DOMAIN); ?>
                    </th>
                    <td>
                        <fieldset>
                            <label>
                                ...
                                <?php echo esc_html__('Collect Address', FLOWQ_TEXT_DOMAIN); ?>
                            </label>
                            <br>
                            <label>
                                <input type="checkbox"
                                ...
                                <?php echo esc_html__('Collect Zipcode', FLOWQ_TEXT_DOMAIN); ?>
                            </label>
                            <br>
                            <label>
                                <input type="checkbox"
                                ...
                                <?php echo esc_html__('Collect Phone Number', FLOWQ_TEXT_DOMAIN); ?>
                            </label>
                        </fieldset>
                    </td>
                </tr>
        ...
        <div class="settings-section">
            <h2><?php echo esc_html__('Privacy Policy Settings', FLOWQ_TEXT_DOMAIN); ?></h2>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="privacy_policy">
                                <?php echo esc_html__('Privacy Policy', FLOWQ_TEXT_DOMAIN); ?>
                            </label>
                        </th>
                        <td>
                            <?php
                            ...
                            ?>
                            <p class="description">
                                <?php echo esc_html__('This text will appear below the participant form with a required checkbox. Leave empty to disable.', FLOWQ_TEXT_DOMAIN); ?>
                            </p>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <th scope="row">
                            <label for="privacy_policy_stage1">
                                <?php echo esc_html__('Privacy Policy - Stage 1', FLOWQ_TEXT_DOMAIN); ?>
                            </label>
                        </th>
                        <td>
                            <?php
                            ...
                            ?>
                            <p class="description">
                                <?php echo esc_html__('Appears on first form (name, email, address, zipcode) with required checkbox', FLOWQ_TEXT_DOMAIN); ?>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <label for="privacy_policy_stage2">
                                <?php echo esc_html__('Privacy Policy - Stage 2 (Phone Number)', FLOWQ_TEXT_DOMAIN); ?>
                            </label>
                        </th>
                        <td>
                            <?php
                            ...
                            ?>
                            <p class="description">
                                <?php echo esc_html__('Appears on second form (phone number) with required checkbox', FLOWQ_TEXT_DOMAIN); ?>
                            </p>
                        </td>
                    </tr>
                </table>
        ...
        <div class="settings-section" id="phone_optional_wrapper" style="<?php echo $two_stage_form != 1 ? 'display:none;' : ''; ?>">
            <h2><?php echo esc_html__('Stage 2 Options', FLOWQ_TEXT_DOMAIN); ?></h2>
            <table class="form-table">
                <tr>
                    <th scope="row">
                        <label for="phone_optional">
                            <?php echo esc_html__('Phone Number Stage', FLOWQ_TEXT_DOMAIN); ?>
                        </label>
                    </th>
                    <td>
                        <label>
                            ...
                            <?php echo esc_html__('Make phone number optional (Stage 2)', FLOWQ_TEXT_DOMAIN); ?>
                        </label>
                        <p class="description">
                            <?php echo esc_html__('When enabled, users can skip the phone number stage. Only applies when two-stage form is enabled.', FLOWQ_TEXT_DOMAIN); ?>
                        </p>
                    </td>
                </tr>
            </table>
        ...
        <p class="submit">
            <input type="submit"
                   ...
                   value="<?php echo esc_attr__('Save Changes', FLOWQ_TEXT_DOMAIN); ?>">
        </p>
    </form>
</div>
