...
class FlowQ_Settings_Admin {
     ...
     * Menu slug
     */
    private $menu_slug = 'flowq-settings';
    ...
    private function init_hooks() {
        ...
        add_action('admin_post_flowq_save_settings', array($this, 'handle_save_settings'));
    ...
    public function enqueue_admin_scripts($hook) {
        ...
        if ($hook !== 'flowq_page_flowq-settings') {
            return;
        }
    ...
    public function render_general_tab() {
        ...
        $two_page_mode = get_option('flowq_two_page_mode', 0);
        ...
        include FLOWQ_PATH . 'admin/templates/general-settings.php';
    }
    ...
    public function render_templates_tab() {
        ...
        include FLOWQ_PATH . 'admin/templates/templates-list.php';
    }
